           ...
           <div class="w-full lg:1/2 py-16 px-12">
            ...
            <form action="{{route('register-user')}}" method="post">
              ...
              <div class="grid grid-cols-2 gap-5">
                <input type="text" placeholder="Firstname" name="firstname" value="{{old('firstname')}}" class="border border-gray-400 py-1 px-2 rounded-lg">
                <span class=" text-red-600">@error('firstname') {{$message}} @enderror</span>
                <input type="text" placeholder="Lastname" name="lastname" value="{{old('lastname')}}" class="border border-gray-400 py-1 px-2 rounded-lg">
              ...
              <div class="mt-5">
                <label for="check">Do you want to register your banquet? If yes click on the <a href="banquetRegister" class="text-blue-900 font-semibold underline">link</a>.</label>
              </div>
