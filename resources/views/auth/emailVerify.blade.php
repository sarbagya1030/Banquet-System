...
<body class="bg-gray-100 font-sans">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded shadow-md w-96 mx-4">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Forgot My Password</h2>
            ...
            <!-- Instructions -->
            <p class="text-gray-600 mb-4">Enter your email address below, and we'll send you a link to reset your
                password.</p>
            ...
            <form action="{{ route('email.verify.post') }}" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition duration-300 w-full">Reset
                    Password</button>
            </form>
            <!-- Back to Login Link -->
