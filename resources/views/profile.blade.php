...
<body class="bg-gray-100">
    ...
    <div class="mt-6 max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('deleteUser-profile', Session::get('loginEmail')) }}" method="POST">
            @csrf
            @method('delete')
            <button type="submit"
                class="mt-4 w-full bg-red-600 text-white py-2 px-4 rounded-md hover:bg-black focus:outline-none focus:ring focus:border-blue-300">
                Delete Profile
            </button>
        </form>
