...
<body class="p-0">
    ...
    <div class="min-h-screen flex justify-center items-center"
        style="background-image: linear-gradient(115deg, #00294A,#0F0E12);">
        <div class="container mx-auto">
            <div
                class=" flex flex-col justify-center lg:flex-row w-2/3 lg:8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
                    ...
                    <form action="{{ route('login-user') }}" class="login_form" method="post" name="form">
                        ...
                        <div class="mt-5">
                            <input type="text" placeholder="Email" name="email"
                                class="border border-gray-400 py-1 px-2 w-full rounded-lg" value="{{ old('email') }}">
                        ...
                        <div class="flex mt-2 underline text-blue-900 justify-end items-center">
                            <a href="{{ route('email.verify.get') }}">Forgot Password?</a>
                        </div>

                        <div class="flex mt-5 align-middle justify-center">
                            <button type="submit"
                                class="w-1/2 bg-blue-400 py-3 text-center text-white rounded-lg hover:bg-black hover:text-white">Login
                            </button>
                        </div>
                        ...
                        <div class="w-full flex items-center justify-center mt-5">
                            <span>
                                Don't have an account? <a href="registration"
                                    class="text-blue-900 font-semibold underline">Sign Up</a>
                            </span>
                        </div>
                </div>
