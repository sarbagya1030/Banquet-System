  ...
  <body>
    ...
    <div class="min-h-screen py-40" style= "background-image: linear-gradient(115deg, #00294A,#0F0E12);">
      <div class="container mx-auto">
        <div class=" flex flex-col lg:flex-row w-10/12 lg:8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
           ...
           <div class="w-full lg:1/2 py-16 px-12">
            ...
            <form  action="{{route('register-owner')}}" method="post">
              ...
              <div class="grid grid-cols-2 gap-5">
                <input type="text" placeholder="Banquetname" name="banquetname" value="{{old('Banquetname')}}" class="border border-gray-400 py-1 px-2 rounded-lg">
                <span class=" text-red-600">@error('banquetname') {{$message}} @enderror</span>
              </div>

              <div class="mt-5">
                <input type="text" placeholder="Email" name="email" value="{{old('email')}}" class="border border-gray-400 py-1 px-2 w-full rounded-lg">
              ...
              <div class="mt-5">
                <input type="text" placeholder="RegistrationNumber" name="registrationNumber" value="{{old('registrationNumber')}}" class="border border-gray-400 py-1 px-2 w-full rounded-lg">
                <span class=" text-red-600">@error('registrationNumber') {{$message}} @enderror</span>
              </div>

              <div class="mt-5">
                <input type="text" placeholder="LicenseNumber" name="licenseNumber" value="{{old('licenseNumber')}}" class="border border-gray-400 py-1 px-2 w-full rounded-lg">
                <span class=" text-red-600">@error('licenseNumber') {{$message}} @enderror</span>
              </div>

              <div class="mt-5">
                <input type="text" placeholder="ContactNumber" name="contactNumber" value="{{old('contactNumber')}}" class="border border-gray-400 py-1 px-2 w-full rounded-lg">
              ...
              <div class="mt-5">
                <input type="password" placeholder="Confirm Password" name="password_confirmation" class="border border-gray-400 py-1 px-2 w-full rounded-lg">
                <span class=" text-red-600">@error('confirm_password') {{$message}} @enderror</span>
              </div>
              ...
              <div class="w-full flex items-center justify-center mt-2">
                <span>
                  Already have an account? <a  href="login" class="text-blue-900 font-semibold underline">Login</a>
                  </span>
              </div>
            </form> 
