                ...
                <div class="space-x-2" id="fcreate" >
                        ...
                        {{-- //available-dates --}}
                          <div class="max-w-2xl mx-auto mt-8 p-6 bg-white shadow-md rounded-md">
                            ...
                            <form id="dates" method="POST"" action="{{route('date',Session::get('loginEmail'))}}">
                              ...
                              <div class="mb-4">
                                ...
                                <input type="date" id="dates" name="dates" class="border rounded-md px-3 py-2 w-full" required>
                                <span class=" text-red-600">@error('dates') {{$message}} @enderror</span>
                              </div>

                          
                              <div class="mt-6">
                                <button type="submit" class="bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Date</button>
                              </div>
                            </form>
                          </div>
                          ...
                          <div class="max-w-2xl mx-auto mt-8 p-6 bg-white shadow-md rounded-md">
                            ...
                            <form id="images" action="{{route('image',Session::get('loginEmail'))}}" method="POST" enctype="multipart/form-data">
                              @csrf           
                              <div class="mb-4">
                                <label for="images" class="block text-gray-700 font-semibold mb-2">Select Image:</label>
                                <input type="file" id="images" name="images" class="border rounded-md px-3 py-2 w-full" required>
                                <span class=" text-red-600">@error('images') {{$message}} @enderror</span>
                              </div>
                          
                              <div class="mt-6">
                                <button type="submit" class="bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Image</button>
                              </div>
                            </form>
                          </div>
